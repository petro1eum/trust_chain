...
def create_mcp_server(tc: "TrustChain", name: str = "trustchain") -> "TrustChainMCPServer":
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", help="Path to Python config file with TrustChain setup")
