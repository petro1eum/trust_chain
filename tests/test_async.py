...
class TestMixedSyncAsync:
    ...
    async def test_async_chain_of_trust(self, tc):
        ...
        step2 = tc._signer.sign("step2", {"value": step1.data * 2}, parent_signature=step1.signature)
        step3 = tc._signer.sign("step3", {"value": step2.data["value"] * 2}, parent_signature=step2.signature)
